...
namespace Shapes {
Lighting::Lighting() : mvp(1.0f), BackColor{1.0f, 1.0f, 1.0f, 1.0f} {
  /* GLfloat vertices[]={ */
  ...
  /*   0,2,3, */
  /* }; */
  GLfloat vertices[] = {//     COORDINATES     //
                        -0.01f, -0.01f, 0.01f,  -0.01f, -0.01f, -0.01f,
                        0.01f,  -0.01f, -0.01f, 0.01f,  -0.01f, 0.01f,
                        -0.01f, 0.01f,  0.01f,  -0.01f, 0.01f,  -0.01f,
                        0.01f,  0.01f,  -0.01f, 0.01f,  0.01f,  0.01f};

  GLuint indices[] = {0, 1, 2, 0, 2, 3, 0, 4, 7, 0, 7, 3, 3, 7, 6, 3, 6, 2,
                      2, 6, 5, 2, 5, 1, 1, 5, 4, 1, 4, 0, 4, 5, 6, 4, 6, 7};

  shader =
      std::make_unique<Shader>("/home/uttkarsh/OpenGL/Renderer_OpenGL/tests/shapes/resources/shaders/basic.shader",
                               "/home/uttkarsh/OpenGL/Renderer_OpenGL/tests/shapes/resources/shaders/basic1.shader");
...
void Lighting::onRender() {
  ...
  shader->UseUniformNumber("u_color", BackColor[0], BackColor[1], BackColor[2],
                           1.0f);
  ebo->Bind();
